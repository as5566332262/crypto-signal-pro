...
<div className="card"><div className="row" style={{justifyContent:"space-between",alignItems:"center"}}><div className="muted">本次結論（最終決策）</div><span className={`badge ${analysis?.finalDecision==="BUY"?"bull":analysis?.finalDecision==="SELL"?"bear":"flat"}`}>{analysis?.finalDecision||"讀取中"}</span></div>
